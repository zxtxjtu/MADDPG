...
def get_args():
    ...
    parser.add_argument("--time-steps", type=int, default=cycle * 600+1, help="number of time steps")
    ...
    parser.add_argument("--evaluate-rate", type=int, default=cycle * 30, help="how often to evaluate model")
